...
export const metadata: Metadata = {
  ...
  description: "A catalog of developer utilities for Ruby, JSON, Base64 files, text comparison, character counting, Unix timestamps, timezones, UUID generation, and everyday workflows.",
