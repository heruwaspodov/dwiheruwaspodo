...
- **Frontend:**
  ...
  - **HTTP Client:** Embedded Scalar-powered HTTP client for sending requests, inspecting responses, managing auth, and generating code snippets.
...
2.  **Developer Utility Belt:**
    - Ruby Hash ↔ JSON, File ↔ Base64, URL encode/decode, text diff, timestamp, UUID, Ruby compiler, Unicode character counting, and an embedded HTTP Client for request execution and code snippets.
